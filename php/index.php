...
<div class="header">
  ...
  echo ('</div>');
    ...
    <div style="color:white;float:right;margin-top:10px;margin-right:10px;">
      <a href="profile" style="font-size:15px;color:white;margin-left:10px;">'.$_SESSION['id'].'</a>
      <div style="float:left;border:2px solid black;border-top:0px;border-left:0px;border-bottom:0px;margin-right:5px;padding:3px;">
        ...
        <a id= "notify-link" href="#" onclick=notify("'.$_SESSION["id"].'") class ="notification"><img onclick ="mouse(event)" class = "profile-near-links" src =../vip/basic_message_txt.svg>
...
'.$count.'
  ...
  <h3><a href ="exit.php" style="background-color:darkred;font-size:9px;padding-top:3px;border-radius:3px;color:white;border:1px solid green;width:30px;height:15px;text-align:center;padding:auto;float:right;margin-top:-10px;margin-right:10px;left:0">Çık</a></h3>
...
if ($_SESSION['login'] == 'ok'){
 ...
 echo '<div class="form-holder"><a onclick = "showShare(event)" href ="#"><div class="share-header"><h3 style="font-family: Impact; font-weight: bold;">Paylaşım</h3></a></div>
  <form style="display:none;" id="share-form"  >
    <!-- NOTE: Başlık -->
   <div class="input-group">
...
<div class="chat" id = "chat">
  <div  id = "chat-link" class="chat-link">
    Sohbet
  </div>
